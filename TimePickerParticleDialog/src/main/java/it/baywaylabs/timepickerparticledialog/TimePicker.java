...
public class TimePicker extends FrameLayout {
    ...
    /**
     * Set the spinner hour visible.
     */
    public void setHourVisible()
    {
        this.mHourPicker.setVisibility(VISIBLE);
    }

    /**
     * Set the spinner hour not visible.
     */
    public void setHourNotVisible()
    {
        this.mHourPicker.setVisibility(GONE);
    }

    /**
     * Set the spinner minute visible.
     */
    public void setMinuteVisible()
    {
        this.mMinutePicker.setVisibility(VISIBLE);
    }

    /**
     * Set the spinner minute not visible.
     */
    public void setMinuteNotVisible()
    {
        this.mMinutePicker.setVisibility(GONE);
    }

    /**
     * Set the spinner seconds visible.
     */
    public void setSecondsVisible()
    {
        this.mSecondPicker.setVisibility(VISIBLE);
    }

    /**
     * Set the spinner seconds not visible.
     */
    public void setSecondsNotVisible()
    {
        this.mSecondPicker.setVisibility(GONE);
    }
}